...
import { User, Shield, Globe, Eye, Download, Trash2, KeyRound, CheckCircle2, Smartphone, Bell, X, ArrowLeft, Wrench } from "lucide-react";
...
const vendorSettingsSchema = z.object({
  jobAlertEmail: z.boolean(),
  jobAlertSms: z.boolean(),
  bidAcceptanceAlerts: z.boolean(),
  completionReminderAlerts: z.boolean(),
  serviceArea: z.string(),
  autoAcceptJobs: z.boolean(),
  workCompletionNotifications: z.boolean(),
...
export default function VendorSettings() {
  ...
  const vendorSettingsForm = useForm<z.infer<typeof vendorSettingsSchema>>({
    resolver: zodResolver(vendorSettingsSchema),
    defaultValues: {
      jobAlertEmail: true,
      jobAlertSms: false,
      bidAcceptanceAlerts: true,
      completionReminderAlerts: true,
      serviceArea: "All Areas",
      autoAcceptJobs: false,
      workCompletionNotifications: true,
  ...
  const updateVendorSettingsMutation = useMutation({
    mutationFn: async (data: z.infer<typeof vendorSettingsSchema>) => {
      toast({ title: "Vendor settings updated successfully" });
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Header 
          ...
          subtitle="Manage your account settings and vendor preferences"
        />
        <main className="flex-1 overflow-y-auto p-6" data-testid="main-vendor-settings">
              ...
              <CardContent className="space-y-4">
                <div className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Receive notifications about jobs, bids, and payments
                    </p>
                  </div>
                  <Switch
                ...
                <div className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Receive urgent job notifications via SMS
                    </p>
                  </div>
                  <Switch
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Get notified about new job opportunities</CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...vendorSettingsForm}>
                  <form onSubmit={vendorSettingsForm.handleSubmit((data) => updateVendorSettingsMutation.mutate(data))} className="space-y-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">Email Job Alerts</FormLabel>
                            <FormDescription>
                          ...
                          <FormControl>
                            <Switch
                              data-testid="switch-job-alert-email"
                              checked={field.value}
                              onCheckedChange={field.onChange}
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">SMS Job Alerts</FormLabel>
                            <FormDescription>
                              Receive SMS notifications for urgent job postings
                            </FormDescription>
                          </div>
                          <FormControl>
                            <Switch
                              data-testid="switch-job-alert-sms"
                              checked={field.value}
                              onCheckedChange={field.onChange}
                            />
                          </FormControl>
                    ...
                    <FormField
                      control={vendorSettingsForm.control}
                      name="bidAcceptanceAlerts"
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">Bid Acceptance Alerts</FormLabel>
                            <FormDescription>
                              Get notified when your bids are accepted
                            </FormDescription>
                          </div>
                          <FormControl>
                            <Switch
                              data-testid="switch-bid-acceptance-alerts"
                              checked={field.value}
                              onCheckedChange={field.onChange}
                            />
                          </FormControl>
                    ...
                    />
                    <Button type="submit" data-testid="button-update-job-alert-settings" disabled={updateVendorSettingsMutation.isPending}>
                      Save Job Alert Settings
                    </Button>
                  </form>
                </Form>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Service Area & Job Preferences</CardTitle>
                <CardDescription>Configure your service area and job handling preferences</CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...vendorSettingsForm}>
                  <form onSubmit={vendorSettingsForm.handleSubmit((data) => updateVendorSettingsMutation.mutate(data))} className="space-y-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input {...field} data-testid="input-service-area" placeholder="e.g., Downtown, North Side, etc." />
                          </FormControl>
                          <FormDescription>Specify the areas where you provide services</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">Auto-Accept Jobs</FormLabel>
                            <FormDescription>
                              Automatically accept jobs within your service area
                            </FormDescription>
                          </div>
                          <FormControl>
                            <Switch
                              data-testid="switch-auto-accept-jobs"
                              checked={field.value}
                              onCheckedChange={field.onChange}
                            />
                          </FormControl>
                    ...
                    />
                    <Button type="submit" data-testid="button-update-service-settings" disabled={updateVendorSettingsMutation.isPending}>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Work & Payment Notifications</CardTitle>
                <CardDescription>Manage notifications for work completion and payments</CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...vendorSettingsForm}>
                  <form onSubmit={vendorSettingsForm.handleSubmit((data) => updateVendorSettingsMutation.mutate(data))} className="space-y-4">
                    <FormField
                      control={vendorSettingsForm.control}
                      name="completionReminderAlerts"
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">Completion Reminder Alerts</FormLabel>
                            <FormDescription>
                              Receive reminders to mark jobs as complete
                            </FormDescription>
                          </div>
                          <FormControl>
                            <Switch
                              data-testid="switch-completion-reminder-alerts"
                              checked={field.value}
                              onCheckedChange={field.onChange}
                            />
                          </FormControl>
                    ...
                    <FormField
                      control={vendorSettingsForm.control}
                      name="workCompletionNotifications"
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">Work Completion Notifications</FormLabel>
                            <FormDescription>
                              Notify property managers when work is completed
                            </FormDescription>
                          </div>
                          <FormControl>
                            <Switch
                              data-testid="switch-work-completion-notifications"
                              checked={field.value}
                              onCheckedChange={field.onChange}
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            <FormLabel className="text-base">Payment Received Alerts</FormLabel>
                            <FormDescription>
                          ...
                          <FormControl>
                            <Switch
                              data-testid="switch-payment-received-alerts"
                              checked={field.value}
                              onCheckedChange={field.onChange}
                            />
                          </FormControl>
                    ...
                    />
                    <Button type="submit" data-testid="button-update-work-payment-settings" disabled={updateVendorSettingsMutation.isPending}>
                      Save Work & Payment Settings
                    </Button>
                  </form>
                </Form>
              </CardContent>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          ...
          <Alert variant="destructive">
            <AlertDescription>
              All your data, including jobs, bids, and payment history will be permanently deleted.
            </AlertDescription>
          </Alert>
          <DialogFooter>
